...
{
    // o OnException vem da interface IExceptionFilter que tem o objetivo de capturar exceções lançadas durante a execução de uma ação em um controlador ASP.NET Core.
