...
builder.Services.AddHttpContextAccessor(); // Adiciona o HttpContextAccessor, necessário para o HttpContextTokenValue obter o contexto HTTP e acessar os headers das requisições
