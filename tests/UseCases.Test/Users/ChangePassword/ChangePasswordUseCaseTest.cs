...
public class ChangePasswordUseCaseTest
{
    ...
    // vai cair e dar erro no validate dentro do use case, pois a nova senha é inválida
    [Fact]
    ...
    // vai cair no _passwordEncripter.Verify pois dentro desse mock ele espera um valor, como não passamos ele vai retornar false
    [Fact]
